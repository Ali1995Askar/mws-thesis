...
from app.src_2.algorithm.max_matching.heuristics.dynamic_min_degree_algo import DynamicMinDegreeAlgo


class TestDynamicMinDegreeAlgo:
    def test_matching_edges_ex_1(self, ex_bipartite_graph_1):
        inst = DynamicMinDegreeAlgo(bipartite_graph=ex_bipartite_graph_1)
    ...
    def test_matching_edges_ex_2(self, ex_bipartite_graph_2):
        inst = DynamicMinDegreeAlgo(bipartite_graph=ex_bipartite_graph_2)
        matching = inst.find_matching_edges()
        ex = []
        for u, v in matching:
            ex.append(u)
    ...
    def test_random(self):
        ...
        for i in range(50):
            ...
            inst = DynamicMinDegreeAlgo(bipartite_graph=bipartite_graph)
            matching = inst.find_matching_edges()
            ex = []
