...
class TestBuildGraphCommand:
    ...
    def test_call_user_name_arg(self, svu_user, mocker):
        selector_mock = mocker.patch('management.selectors.ExecutionHistorySelectors.build_random_graph_by_density')
    ...
    def test_wrong_values(self, svu_user, mocker):
        mocker.patch('management.selectors.ExecutionHistorySelectors.build_random_graph_by_density')
